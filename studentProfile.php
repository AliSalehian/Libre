...
<div id="Menu">
    ...
    <ul>
        ...
        <li class="floatLeft studentProfile studentProfileSelected">
            <?php
...
<div class="page">
    ...
    <form method="post">
        <div class="leftProfile firstLeftProfile">
            ...
            <p class="profileInputTitle">Student ID</p>
            <input name="studentIDProfile" class="inputProfile" value="SID-<?php echo $row['id'] ?>" readonly>
        </div>
